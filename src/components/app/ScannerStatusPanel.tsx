  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <div className="mt-1 text-sm font-medium">
            {scanner?.enabled === false ? "Scanner disabled" : scanner?.nftListEnrichDryRun === false ? "Write mode enabled" : "Dry-run mode"}
          </div>
        </div>
      ...
      <div className="mt-4 grid gap-3 text-xs text-muted-foreground sm:grid-cols-4">
        <div>
          <div>Batch size</div>
          <div className="mt-1 font-mono text-foreground">{scanner?.nftListEnrichBatchSize ?? scanner?.batchSize ?? "..."}</div>
        </div>
        <div>
      ...
      <div className="mt-3 grid gap-3 text-xs text-muted-foreground sm:grid-cols-4">
        <div>
          <div>Metadata updated</div>
          <div className="mt-1 font-mono text-foreground">{latest?.metadataUpdated ?? 0}</div>
        </div>
        <div>
          <div>Images updated</div>
          <div className="mt-1 font-mono text-foreground">{latest?.imagesUpdated ?? 0}</div>
        </div>
        <div>
          <div>Owners updated</div>
          <div className="mt-1 font-mono text-foreground">{latest?.ownersUpdated ?? 0}</div>
        </div>
        <div>
          <div>Last activity updated</div>
          <div className="mt-1 font-mono text-foreground">{latest?.lastActivitiesUpdated ?? 0}</div>
        </div>
      </div>
